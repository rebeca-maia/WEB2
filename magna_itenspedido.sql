CREATE DATABASE  IF NOT EXISTS `magna` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `magna`;
...
CREATE TABLE `itenspedido` (
  ...
  CONSTRAINT `fk_pedido` FOREIGN KEY (`fk_pedido`) REFERENCES `pedido` (`idpedido`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_produto` FOREIGN KEY (`fk_produto`) REFERENCES `produto` (`idproduto`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
-- Dump completed on 2017-11-29  8:06:56
